...
export default function ColorGenerator() {
  ...
  return (
    <ToolLayout
      ...
      description="Generate beautiful, random color palettes for your next project."
      ...
      <div className="flex flex-col h-[calc(100vh-250px)] min-h-[500px] gap-8">
        <div className="flex justify-center">
          <Button 
            ...
            className="px-8 h-12 text-base font-semibold shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all hover:-translate-y-0.5"
          >
        ...
        <div className="bg-muted/50 rounded-xl p-6 text-center text-muted-foreground border border-border/50 border-dashed">
          <p>Click on any color card to copy its HEX code instantly.</p>
        </div>
      </div>
    </ToolLayout>
  );
